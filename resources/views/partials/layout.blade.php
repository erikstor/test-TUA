...
<div class="col-12 d-flex">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="{{ url('tasks') }}" class="nav-link text-white {{ request()->is('tasks') ? 'active':'' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             class="bi bi-list-task pe-none me-2" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                   ...
                   data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <strong class="ms-2">Settings</strong>
                </a>
                <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                    ...
                    <li>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST">
                            @csrf
                            <a class="dropdown-item" href="#logout-form" id="send-logout">
                                Logout
                            </a>
                        </form>
                    </li>
    ...
    <div class="col">
        ...
        @auth()
            <div class="col-12">
                <nav class="navbar navbar-expand-md navbar-light bg-light mb-4 shadow p-3 mb-5 bg-body">
                        ...
                        <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarCollapse">
                            ...
                            <div class="me-3">
                                <div  class="d-flex" >
                                    ...
                                    <div id="quantity_tasks" data-url="{{ route('get-quantity-task') }}">
                                        0
                                    </div>
                                </div>
                            </div>
